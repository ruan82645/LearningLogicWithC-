...
// TimeSpan é usado para armazenas a diferença entre duas datas(ela não tem propriedade de ano, mes e semana. Apenas dia para baixo)
...
Console.WriteLine($"você tem {idadeatual} anos, {mesesatuais} meses, {semanasatuais} semanas, {diferenca.Days} dias, {diferenca.Hours} horas e {diferenca.Seconds} segundos");
